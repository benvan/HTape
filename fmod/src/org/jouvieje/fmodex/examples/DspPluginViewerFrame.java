...
public abstract class DspPluginViewerFrame extends JFrame {
	...
	public final static String TITLE = "DSP Plugin Viewer Example. Copyright (c), Firelight Technologies Pty, Ltd 2004-2010.";
	...
	private JPanel getPluginPanel() {
		if(pluginPanel == null) {
			...
			pluginPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Plugins",
					javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
					javax.swing.border.TitledBorder.DEFAULT_POSITION, null, null));
