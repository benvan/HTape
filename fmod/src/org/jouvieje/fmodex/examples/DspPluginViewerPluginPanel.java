...
public abstract class DspPluginViewerPluginPanel extends JPanel {
	...
	private void initialize() {
		...
		this.setBorder(javax.swing.BorderFactory.createTitledBorder(null, BufferUtils.toString(plugin.name) + " "
				+ String.format("%1x.%2x", plugin.version.get(0) >> 16, plugin.version.get(0) & 0xFFFF),
