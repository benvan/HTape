...
//		soundBuffer = Medias.loadMediaIntoMemory("/home/ben/Downloads/bittorrent/The Suburbs [mp3-320-2010]/08 - Half Light II (No Celebration).mp3");
//		exinfo = FMOD_CREATESOUNDEXINFO.allocate();
//		exinfo.setLength(soundBuffer.capacity());
		result = system.createStream("/home/ben/Downloads/bittorrent/The Suburbs [mp3-320-2010]/08 - Half Light II (No Celebration).mp3", FMOD_SOFTWARE | FMOD_LOOP_NORMAL, null, sound);
		errorCheck(result);
